...
<main>
  <!-- Hero Section -->
  <section class="pt-[160px] pb-section-gap px-gutter max-w-[1280px] mx-auto">
    <div class="grid grid-cols-1 lg:grid-cols-12 gap-stack-lg items-end">
      <div class="lg:col-span-8">
        <span class="font-label-caps text-secondary uppercase mb-stack-sm block">Naše přístupy</span>
        <h1 class="font-display-xl text-display-xl text-primary mb-stack-md">
          Nezávislý finanční<br />
          audit
        </h1>
  ...
  <section class="py-section-gap bg-surface-container-lowest">
    <div class="max-w-[1280px] mx-auto px-gutter grid grid-cols-1 md:grid-cols-2 gap-section-gap items-center">
      <div class="relative">
        ...
        />
        <div class="absolute -bottom-10 -right-10 w-64 h-64 bg-primary p-stack-md hidden lg:flex flex-col justify-end text-on-primary">
          <span class="font-display-xl text-display-xl leading-none">25+</span>
      ...
      <div class="space-y-stack-md">
        ...
        <p class="font-body-md text-body-md text-on-surface-variant border-l-2 border-secondary pl-stack-md italic">
  ...
  <!-- Klíčové oblasti Section -->
  <section class="py-section-gap bg-primary text-on-primary overflow-hidden">
    <div class="max-w-[1280px] mx-auto px-gutter">
      <div class="text-center mb-[80px]">
        <span class="font-label-caps text-secondary-fixed uppercase mb-stack-sm block">Klíčové oblasti</span>
        <h2 class="font-headline-lg text-headline-lg mb-stack-md">Čím se zabýváme</h2>
      </div>
      <div class="grid grid-cols-1 md:grid-cols-3 gap-stack-lg">
        <div class="p-stack-md border border-primary-container hover:border-secondary transition-colors group">
          <span class="material-symbols-outlined text-secondary-fixed text-[40px] mb-stack-md">verified_user</span>
          <h3 class="font-headline-md text-headline-md mb-stack-sm">Zajištění rizik</h3>
          <p class="font-body-md text-on-primary-container group-hover:text-on-primary transition-colors">
            Správně nastavené zajištění vám přináší především klid. Víte, že ať se stane cokoliv, máte oporu a vaše
            finanční stabilita není ohrožena jednou nečekanou událostí.
          </p>
        </div>
        <div class="p-stack-md border border-primary-container hover:border-secondary transition-colors group">
          <span class="material-symbols-outlined text-secondary-fixed text-[40px] mb-stack-md">visibility</span>
          <h3 class="font-headline-md text-headline-md mb-stack-sm">Daňové poradenství</h3>
          <p class="font-body-md text-on-primary-container group-hover:text-on-primary transition-colors">
            Díváme se na vaše daně v souvislostech, ne izolovaně. Ukážeme vám, kde dává smysl upravit strukturu, co
            využít a co naopak nedělat, abyste se vyhnuli zbytečným nákladům i rizikům.
          </p>
        </div>
        <div class="p-stack-md border border-primary-container hover:border-secondary transition-colors group">
          <span class="material-symbols-outlined text-secondary-fixed text-[40px] mb-stack-md">lock</span>
          <h3 class="font-headline-md text-headline-md mb-stack-sm">Právní poradenství</h3>
          <p class="font-body-md text-on-primary-container group-hover:text-on-primary transition-colors">
            Naším cílem není jen reagovat na vzniklé situace, ale především jim předcházet. Pomáháme nastavovat právní
            vztahy tak, aby byly funkční, srozumitelné a dlouhodobě udržitelné.
          </p>
        </div>
      </div>
    </div>
  ...
  <!-- Další služby Section -->
  <section class="py-section-gap bg-background">
    <div class="max-w-[1280px] mx-auto px-gutter">
      <div class="flex flex-col md:flex-row justify-between items-end mb-[80px]">
        <div>
          <span class="font-label-caps text-secondary uppercase mb-stack-sm block">Další služby</span>
          <h2 class="font-headline-lg text-headline-lg text-primary">Kompletní přehled služeb</h2>
        </div>
        <p class="font-body-md text-on-surface-variant max-w-sm mt-stack-md md:mt-0">
          Nabízíme komplexní poradenství v oblasti osobních i firemních financí, majetku a investic.
        </p>
      </div>
      <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-stack-md">
        <div class="group">
          <div class="aspect-[3/4] mb-stack-sm overflow-hidden bg-surface-container relative">
            <img
          ...
          <h3 class="font-headline-md text-2xl text-primary mb-1">Energetická optimalizace</h3>
          <p class="font-label-caps text-secondary uppercase mb-stack-sm">Správa energií a nákladů</p>
          <a class="inline-flex items-center text-on-surface-variant hover:text-secondary transition-colors font-label-caps uppercase tracking-widest gap-2" href="#">
            Zjistit více
        ...
        <div class="group">
          ...
          <h3 class="font-headline-md text-2xl text-primary mb-1">Odškodnění</h3>
          <p class="font-label-caps text-secondary uppercase mb-stack-sm">Pracovní úrazy a pojistné události</p>
          <a class="inline-flex items-center text-on-surface-variant hover:text-secondary transition-colors font-label-caps uppercase tracking-widest gap-2" href="#">
            Zjistit více
            <span class="material-symbols-outlined text-[16px]">arrow_forward</span>
          </a>
        ...
        <div class="group">
          ...
          <h3 class="font-headline-md text-2xl text-primary mb-1">Realitní služby</h3>
          <p class="font-label-caps text-secondary uppercase mb-stack-sm">Prodej a pronájem nemovitostí</p>
          <a class="inline-flex items-center text-on-surface-variant hover:text-secondary transition-colors font-label-caps uppercase tracking-widest gap-2" href="#">
            Zjistit více
            <span class="material-symbols-outlined text-[16px]">arrow_forward</span>
          </a>
        ...
        <div class="group">
          ...
          <h3 class="font-headline-md text-2xl text-primary mb-1">Správa nemovitostí</h3>
          <p class="font-label-caps text-secondary uppercase mb-stack-sm">Kompletní správa portfolia</p>
          <a class="inline-flex items-center text-on-surface-variant hover:text-secondary transition-colors font-label-caps uppercase tracking-widest gap-2" href="#">
            Zjistit více
            <span class="material-symbols-outlined text-[16px]">arrow_forward</span>
          </a>
  ...
  <!-- CTA Section -->
  <section class="py-section-gap border-t border-outline-variant/30">
    <div class="max-w-[1280px] mx-auto px-gutter text-center">
      <h2 class="font-headline-lg text-headline-lg text-primary mb-stack-md">Chci jasno ve svých financích</h2>
      <p class="font-body-md text-on-surface-variant mb-stack-lg max-w-xl mx-auto">
        Audit vám nepřinese jen seznam změn, ale především klid a kontrolu. Budete přesně vědět, jak na tom jste a jaké
        kroky dávají smysl dál – ať už chcete optimalizovat současný stav, nebo se připravit na další životní etapu.
      </p>
      <div class="flex flex-col sm:flex-row justify-center gap-stack-md">
        <button class="bg-primary text-on-primary px-stack-lg py-stack-md font-label-caps uppercase tracking-widest hover:bg-primary-container transition-colors">
          Chci jasno ve svých financích
        </button>
        <button class="border border-primary text-primary px-stack-lg py-stack-md font-label-caps uppercase tracking-widest hover:bg-surface-container transition-colors">

...
$description = 'Developerské projekty vnímáme jako komplexní proces, kde se propojuje vize, kapitál, trh i správné načasování. Podílíme se na celém procesu od analýzy příležitosti až po finální prodej.';
...
<main class="pt-20">
  ...
  <section class="relative h-[614px] min-h-[500px] flex items-center justify-center overflow-hidden">
    ...
    <div class="relative z-10 max-w-[1280px] mx-auto px-gutter w-full">
      <span class="font-label-caps text-secondary-fixed mb-stack-sm block">KAPITÁLOVÉ INVESTICE</span>
      <h1 class="font-display-xl text-display-xl text-on-primary max-w-2xl">Developerské projekty</h1>
      <p class="font-body-lg text-body-lg text-on-primary-container max-w-xl mt-stack-md opacity-90">
        Developerské projekty vnímáme jako komplexní proces, kde se propojuje vize, kapitál, trh i správné načasování.
        Každý krok, od výběru lokality až po finální prodej, má zásadní vliv na celkový výsledek.
      </p>
    </div>
  </section>
  ...
  <section class="bg-primary py-section-gap">
    <div class="max-w-[1280px] mx-auto px-gutter text-center">
      <h2 class="font-display-xl text-display-xl text-on-primary mb-stack-md">Zapojte se do projektů</h2>
      <p class="font-body-lg text-body-lg text-on-primary-container max-w-2xl mx-auto mb-stack-lg">
        Výsledkem jsou projekty, které jsou funkční, ekonomicky udržitelné a atraktivní pro trh. Pro investory to
        znamená jasně řízený proces a kontrolu nad kapitálem.
      </p>
